...
Source section: `New Feats` ... `Your Role on a Hunt` from `public/data/gtmh-patreon/gtmh-patreon.md` / chapter 2.
Curated for structure: prerequisite lines, blank-line paragraphs, and markdown bullets matching the PDF benefit lists.
