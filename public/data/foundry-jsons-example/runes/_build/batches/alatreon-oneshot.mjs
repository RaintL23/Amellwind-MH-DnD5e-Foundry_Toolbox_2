/**
 * Alatreon one-shot recommended runes
 * Run via: node public/data/foundry-jsons-example/runes/_build/build.mjs alatreon-oneshot
 */
...
const { metaList, idsByName } = loadBatchData(path.resolve(__dirname, "../data/alatreon-oneshot"));
