/**
 * Requested runes batch (35 items)
 * Run via: node public/data/foundry-jsons-example/runes/_build/build.mjs requested
 */
...
const { metaList, idsByName } = loadBatchData(path.resolve(__dirname, "../data/requested"));
