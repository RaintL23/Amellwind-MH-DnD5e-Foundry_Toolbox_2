---
name: Alpha Doshaguma
slug: alpha-doshaguma
group: Fanged Beasts
cr: "5"
pdfPage: 274
inGithubJson: false
...
The doshaguma has advantage on Wisdom (Perception) checks that rely on smell.
...
The doshaguma makes one Bite attack and one Claw attack. It can replace its Claw attack with a Smash (if available).
...
Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 16 (3d8 + 3) bludgeoning damage. If the doshaguma moved at least 10 feet straight toward the target immediately before the hit, the target takes an extra 13 (3d8) bludgeoning damage. If the target is a creature, it must succeed on a DC 14 Strength saving throw or be pushed up to 10 feet away and knocked prone.
...
- **Weapon effect:** While attuned to this weapon you can use an action to speak its commmand word, transforming it into a telescope for 10 minutes or a magnifying glass for 1 minute.
...
- **Carve:** 5-9
- **Capture:** 3-4
- **Armor effect:** Free Meal. While attuned to this armor, you no longer need to eat or drink.
- **Weapon effect:** Charger. When you use the Dash action, you can use the Shove action as a Bonus Action on the same turn.
...
- **Weapon effect:** Archaeologist. When you successfully gather a bone resource, you instead gather 2.
...
- **Carve:** 20
- **Capture:** 20
- **Armor effect:** Fortify. When you regain consciousness from being reduced to 0 hit points, you gain a +1 bonus to your AC, Attack, and Damage rolls for 1 minute. Once this property has been activated, it can't be used again until you finish a long rest.
- **Weapon effect:** Powerhouse. When you use a reaction that increases your AC and causes an attack that would hit to miss, the next attack with this weapon deals extra damage equal to your proficiency bonus.
