---
name: Tempered Ebony Odogaron
slug: tempered-ebony-odogaron
...
| --- | --- | --- | --- |
| 1-4 | 1-4 | T.Ebony Scale | A, W |
| 5-9 | 5-9 | T.Ebony Sinew | A, W |
| 10-13 | 10-12 | T.Ebony Claw | A, W |
| 14-15 | 13-14 | T.Ebony Fang | W |
| — | 15-17 | Nourishing Extract x2 | O |
| 16-18 | — | T.Ebony Tail | A, W |
| 19 | 18 | T.Ebony Plate | A, W |
| 20 | 19-20 | T.Ebony Gem | W |
...
- **Weapon effect:** You gain a +2 bonus to your spell attack rolls and spell save DC while attuned to this weapon. This bonus increases to +3 when the spell you are casting deals necrotic damage, such as the inflict wounds or vampiric touch spell.
...
- **Carve:** 10-13
- **Capture:** 10-12
- **Armor effect:** While you wear this armor you have advantage on Charisma (Intimidation) and Dexterity (Acrobatic) checks.
- **Weapon effect:** While attuned to this weapon, your eyes glow red, your mouth emits a black smoke, and your weapon deals an extra 1d8 necrotic damage.
...
- **Carve:** 14-15
- **Capture:** 13-14
- **Armor effect:** Marathon Runner+. While wearing this armor, your walking speed increases by 10 feet and you ignore difficult terrain if it was not created by a magical effect.
- **Weapon effect:** When you hit a creature with this weapon, you can choose to wound it. A wounded creature takes 1d6 damage at the start of each of its turns for each wound it has. At the end of each of its turns, it can make a DC 16 Constitution saving throw, ending all wounds on a success. Alternatively, the creature or an adjacent ally can use an action to make a DC 15 Wisdom (Medicine) check, ending all wounds on a success.

### Nourishing Extract x2
...
- **Weapon effect:** Critical Status (dragonblight). When you make a weapon attack with this weapon, and roll a 20 for the attack roll, the target is afflicted with dragonblight until the end of its next turn.
