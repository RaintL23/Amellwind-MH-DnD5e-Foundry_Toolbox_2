...
- **Saving Throws:** Dex +7, Wis +5, Cha +2
...
The barioth is accustomed to moving through the frozen tundras, as such it ignores difficult terrain for snow, ice, and other cold weather effects.
...
The barioth makes one Bite attack, one Claw attack, and one tail attack.
...
Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 15 (2d10 + 4) bludgeoning damage, and the target plus each creature adjacent to it must succeed on a DC 12 Strength saving throw or be pushed 10 feet away and be knocked prone. Vortex (Recharge 5-6) The barioth creates a vortex of ice and snow at a point within 60 feet of it. Each creature in a 15-foot-radius, 40-foot-high cylinder centered on a point must make a DC 14 Dexterity saving throw, taking 22 (5d8) bludgeoning damage plus 7(2d6) cold damage on a failed save, or half as much damage on a successful save.
...
| --- | --- | --- | --- |
| 1-4 | — | Y.Barioth Cortex | A, W |
| 5-6 | 1-6 | Y.Barioth Fur | A, W |
| 7-10 | 7-9 | Y.Barioth Talon | A, W |
| 11-13 | 10-13 | Freezer Sac | A, W |
| 14 | 14-17 | Y.Barioth Spike | A, W |
| 15-19 | — | Y.Barioth Tail | A, W |
| 20 | 18-20 | Small Amber Tusks | A, W |
