...
const WEAPON_NAME_TO_SPECIFIC_TAGS: Record<string, string[]> = {
  ...
  "Dual Blades": ["weapon-type:dual-blades", "weapon-type:bladed"],
  "Dual Repeaters": ["weapon-type:dual-repeaters"],
  "Light Bowgun": ["weapon-type:light-bowgun", "weapon-type:bowgun"],
  "Heavy Bowgun": ["weapon-type:heavy-bowgun", "weapon-type:bowgun"],
  Tonfas: ["weapon-type:tonfas"],
  "Sword and Shield": ["weapon-type:sword-and-shield", "weapon-type:bladed"],
