...
export function PaperDoll() {
  ...
  const [selectedSlot, setSelectedSlot] = useState<EquipmentSlotType | null>(
    null,
  );
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 flex flex-col items-center gap-4">
      ...
      <div className="relative w-full max-w-[320px] aspect-[3/4] flex items-center justify-center">
        ...
        <div className="absolute grid grid-cols-3 grid-rows-3 w-full h-full p-4">
          ...
          <div className="flex items-center justify-start">
            {hasIntegratedShield ? (
              ...
              <EquipmentSlot
                ...
                icon={
                  <Sword
                    className={cn("h-4 w-4", offHand && "text-blue-400")}
                  />
                }
                equipped={
                  offHand
          ...
          <div className="flex items-center justify-end">
            <EquipmentSlot
              label="Main Hand"
              icon={
                <Sword className={cn("h-4 w-4", mainHand && "text-red-400")} />
              }
              equipped={
                mainHand
                  ? {
      ...
      {selectedSlot && !(selectedSlot === "offHand" && hasIntegratedShield) && (
