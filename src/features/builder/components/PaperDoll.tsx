...
export function PaperDoll() {
  ...
  function handleRuneSlotClick(slot: typeof selectedSlot) {
    if (slot) selectSlot(slot);
    else if (mainHand) selectSlot("mainHand");
    else if (armor) selectSlot("armor");
  }
    ...
    <div className="flex min-w-0 flex-col gap-2.5">
      ...
      >
        <EquipmentGridPanel
          ...
          onRuneSlotClick={handleRuneSlotClick}
        />
      </BuilderPanel>
