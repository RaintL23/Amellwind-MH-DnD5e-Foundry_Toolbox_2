...
export function CharacterBuilderProvider({ children }: Readonly<{ children: ReactNode }>) {
  ...
  const contextValue = useMemo<CharacterBuilderContextValue>(
    () => ({
      ...
      speciesSpellGroupChoice: identity.speciesSpellGroupChoice,
      setSpeciesSpellGroupChoice: identity.setSpeciesSpellGroupChoice,
      ...
      allWeaponGrants: proficiency.allWeaponGrants,
      ...
      speciesWeaponChoices: proficiency.speciesWeaponChoices,
      ...
      setSpeciesWeaponChoices: proficiency.setSpeciesWeaponChoices,
