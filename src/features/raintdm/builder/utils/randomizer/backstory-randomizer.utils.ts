import { XGE_SECTIONS, TABLE_BY_ID } from "@/features/dnd/xanathar-backstory/data/xanathar-tables.data";
import {
  extractLifestyleModifier,
  rollOnTable,
  type RollContext,
  type RollResult,
} from "@/features/dnd/xanathar-backstory/utils/xanathar-roll.utils";
import { cascadeDependents } from "@/features/dnd/xanathar-backstory/utils/xanathar-cascade.utils";
import { formatBackstorySummaryText } from "@/features/dnd/xanathar-backstory/utils/xanathar-summary-text.utils";
