...
import {
  ...
  getListClasses,
} from "@/features/dnd/classes/services/class.service";
...
import { useClassVariants } from "@/features/raintdm/builder/hooks/useClassVariants";
...
import { isClothingArmor } from "@/features/raintdm/builder/data/armor.data";
import { getClassEquipmentConflictReason } from "@/features/raintdm/builder/utils/equipment-proficiency.utils";
import {
...
export function ClassLibraryPanel({
  ...
  const subclassEntities = useMemo(() => {
    ...
    return subclassesForClassVariant(sourceClassData);
  }, [
    isSubclassSlot,
    isMulticlassSubclassPicker,
    multiclassSubclassIndex,
  ...
  const subclassOptions = useMemo(
    () => dedupeByNameToListOptions(subclassEntities),
    [subclassEntities],
  );
