...
import { buildWeaponItem } from "@/features/raintdm/builder/foundry-export/item.builders";
import {
  applyItemAutomation,
...
import { hasWeaponSwitchModes } from "@/features/amellwind/weapons/utils/weapon-mode.utils";
import {
