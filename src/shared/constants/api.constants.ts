...
/** Prop → brew-relative-path map (which files contain class/spell/…). */
export const UA_INDEX_PROPS_URL = `${UA_BASE_URL}/_generated/index-props.json`;
...
/** Prop → brew-relative-path map (which files contain class/spell/…). */
export const HOMEBREW_INDEX_PROPS_URL = `${HOMEBREW_BASE_URL}/_generated/index-props.json`;
